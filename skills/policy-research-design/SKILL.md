...
**발주처 양식이 있으면 그 골격이 우선한다.** 양식은 장 구조와 앞부속을 제출 요건으로 고정하되 "장 제목을 달리할 수 있음"을 허용하는 경우가 많다 — 그때는 골격을 양식에 맞추고 장 제목·절 구성만 RQ와 논증 흐름으로 채운다. 목차를 몇 단까지 작성할지(보통 '절'까지)도 양식을 따른다.
